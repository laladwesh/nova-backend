...
export function AddEntityPanel({ schoolId, classes, teachers, students, onAdded }) {
  ...
  return (
    <>
      ...
      <aside className="w-80 hide-scrollbar md:w-96 bg-white rounded-xl shadow-xl p-6 sticky top-8 h-[calc(90vh-4rem)] overflow-y-auto">
            ...
            {mode === "class" && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 max-h-32 overflow-auto border hide-scrollbar rounded-lg p-2">
                    {teachers.map(t => (
                ...
                <div>
                  ...
                  <div className="space-y-2 max-h-32 hide-scrollbar overflow-auto border rounded-lg p-2">
                    {students.map(s => (
