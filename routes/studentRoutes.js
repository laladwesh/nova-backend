...
router.get(
  ...
  isTeacherOrAdmin,       // ensure teacher or admin role
  studentController.listStudents // handler logic
);

/**
 * 2. GET '/par/:parentId' – List students by parent ID
 *    - Any authenticated user may query
 *    - Returns all students linked to the given parentId
 */
router.get(
  '/par/:parentId',
  authenticate,
  studentController.getStudentByParentId
);
